export default async function ( {store,route , redirect}) {
    ...
    const allowedPaths = ['/', '/login','/forgot-password' ,'/register/wholesale','/register/ship_supply', '/register/retail','/about','/services','/privacy-policy','/faqs','/terms-conditions','/contact']; // Add allowed paths here
