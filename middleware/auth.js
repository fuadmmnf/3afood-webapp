export default async function ( {store,route , redirect}) {
    ...
    const allowedPaths = ['/','/our-products', '/login','/forgot-password' ,'/register/wholesale', '/register/retail','/about','/services','/privacy-policy','/faqs','/terms-conditions','/online-order','/contact']; // Add allowed paths here
